# -*- coding: utf-8 -*-
"""
Created on Thu Nov 19 14:55:22 2020
...
"""ici"""
df_non_fraude = df_shuffle.loc[df_shuffle['Class'] == 0][0:num_train*10 ]
df_train = pd.concat([df_fraude, df_non_fraude])
df_train = df_train.sample(frac=1)

# base de test
df_fraude = df_shuffle.loc[df_shuffle['Class'] == 1][num_train:num_fraude]
df_non_fraude = df_shuffle.loc[df_shuffle['Class'] == 0][num_train:num_fraude*10]
